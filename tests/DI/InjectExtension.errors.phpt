...
services:
	service:
		...
		inject: yes
');
}, InvalidStateException::class, 'Service of type DateTimeImmutable required by ServiceA::$a not found.
...
services:
	service:
		...
		inject: yes
');
}, InvalidStateException::class, "Class 'Unknown' required by ServiceB::\$a not found.
